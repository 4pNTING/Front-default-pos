...
const CreateComponent = ({
  ...
  const { toggleCreateComponent, setToggleCreateComponent, createMenuItemAPI, categoryList, loading } = useMenuItemStore();
  const { createMenuItemMutation } = useMenuItemMutations();
      ...
      <div className="flex flex-col h-full bg-white dark:bg-gray-900">
        <div className="flex items-center justify-between px-6 py-4 bg-[#0A3981] text-white">
          <div className="flex items-center gap-2">
            <i className="tabler-circle-plus text-[20px]" />
